"""
Django settings for AsisScan project.
...
SECRET_KEY = 'django-insecure-))-!d*t6r1b*m^3e$o4fkp9(b$spiyqi!p=ykc)ynwn3lad@r*'
...
WSGI_APPLICATION = 'AsisScan.wsgi.application'
